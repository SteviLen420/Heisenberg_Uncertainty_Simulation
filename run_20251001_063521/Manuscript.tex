...
\pandocbounded{\includegraphics[keepaspectratio,alt={The uncertainty product as a function of the initial position's standard deviation.}]{uploaded:uncertainty_product.png}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio,alt={Position probability density distribution.}]{uploaded:position_density_sigma3.0.png}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio,alt={Momentum probability density distribution.}]{uploaded:momentum_density_sigma3.0.png}}
...
\pandocbounded{\includegraphics[keepaspectratio,alt={Time evolution of the position uncertainty.}]{uploaded:free_spreading_sigma_x_t.png}}
